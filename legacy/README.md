...
These are the original files I have published on this Github repo in 2017.

Since then I have been working intermitently on this project till 2026 without publishing changes to Github, so almost every bit of what it was originally published has changed.

I'm leaving this folder as a legacy of how it started.
